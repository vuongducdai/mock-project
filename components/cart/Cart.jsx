          ...
          <Grid item md={8} xs={12}>
            {isValidating ? (
              ...
              <Stack direction="column" pt={3} spacing={2}>
                ...
                >
                  {quantityOrder > 0 ? 'GIỎ HÀNG CỦA BẠN' : 'TÚI CỦA BẠN TRỐNG'}
                </Typography>
                {quantityOrder > 0 ? (
                  <>
                    <Stack
                    ...
                    >
                      <Typography gutterBottom>
                        TỔNG CỘNG ({calculateQuantityCart(products)} sản phẩm)
                      </Typography>
                      <Typography
                        gutterBottom
                        sx={{
                    ...
                    <Typography gutterBottom>
                      Các mặt hàng trong giỏ hàng của bạn không được bảo lưu —
                      hãy kiểm tra ngay để đặt hàng.
                    </Typography>
                    <Divider
          ...
          <Grid item md={4} xs={12}>
            {isValidating ? (
              ...
              >
                {quantityOrder > 0 && (
                  <>
                    ...
                    >
                      ...
                      >
                        <Typography gutterBottom>
                          {calculateQuantityCart(products)} SẢN PHẨM
                        </Typography>
                        <Typography gutterBottom>
                          {formatNumber(totalPrice)}
                        </Typography>
                      ...
                      >
                        ...
                        <Typography gutterBottom>MIỄN PHÍ</Typography>
                      </Stack>
                      <Stack
                        direction="row"
                        justifyContent="space-between"
                ...
                <Stack mt={2} direction="column" className="hidden mdMui:flex">
                  <Typography gutterBottom>
