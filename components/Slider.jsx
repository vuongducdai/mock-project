        ...
        <Container className="product__slider mt-28">
            <Box className="flex border-y-2 mb-4">
                ...
                <span
                    ...
                    className={`p-2 cursor-pointer text-neutral-500 ${listActive === 2 ? 'border-b-2 border-b-black text-black' : ''} hover:border-b-2 border-b-black`}>
                    Tinh hoa adidas
                </span>
                <span
                    onClick={() => setListActive(3)}
                    className={`p-2 cursor-pointer text-neutral-500 ${listActive === 3 ? 'border-b-2 border-b-black ext-black' : ''} hover:border-b-2 border-b-black`}>
                    Sắp có
                </span>
            </Box>
            {listSlider()}
